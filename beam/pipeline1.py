...
class JobOptions(PipelineOptions):
    ...
    def _add_argparse_args(cls, parser):
        ...
        parser.add_value_provider_argument("--dataset_name", type=str, help="BigQuery dataset name.")
        parser.add_value_provider_argument("--table_name", type=str, help="Table name of dataset")
        parser.add_value_provider_argument("--input_data", type=str, help="Dataset in csv format")
